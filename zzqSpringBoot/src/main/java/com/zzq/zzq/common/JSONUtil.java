...
public class JSONUtil {
    ...
    public static String toJson(Object object) throws Exception {
        ...
        try {
            ...
            throw new Exception("Erorr happen when parsing object to json");
        }
    }
    ...
    public static <T> T toObject(String json, Class<T> clazz) throws Exception {
        if (StringUtils.isEmpty(json)) {
            ...
            try {
                ...
                throw new Exception("Error happen when convent json to object, json: " + json + ", class: " + clazz, var5);
            }
    ...
    public static <T> T toObject(Map map, Class<T> clazz) throws Exception {
        if (map == null) {
            return null;
        } else {
    ...
    public static Map<String, Object> getBeanFlatMap(Object object) throws Exception {
        if (object == null) {
            return null;
        } else {
    ...
    public static String getParamsString(Object object) throws Exception {
        if (object == null) {
            return null;
        } else {
    ...
    public static <T> T toObject(String jsonString, TypeReference<T> typeReference) throws Exception {
        if (jsonString == null) {
            return null;
        } else {
            ObjectMapper mapper = new ObjectMapper();
            ...
            try {
                ...
                throw new Exception("Error happen when convent json to object, json: " + jsonString + ", class: " + typeReference, var5);
            }
        }
    }
    ...
    public static <T> T toCollectionObject(String jsonString, Class<?> collectionClass, Class<?> elementClasses) throws Exception {
        ...
        try {
            ...
            throw new Exception("Error happen when convent json to object, json: " + jsonString + ", collectionClass: " + collectionClass + ", class: " + elementClasses, var6);
        }
    }
